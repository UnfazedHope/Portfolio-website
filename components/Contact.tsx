    ...
    <section id="contact" className="scroll-mt-16 lg:mt-16">
      ...
      <div className="flex flex-col gap-4 lg:px-6 mb-8">
        ...
        <p className="lg:text-lg lg:text-start text-muted-foreground">
          I&#39;m always on the lookout for new opportunities and eager to connect. 
          If you&#39;re interested in how my skills and experiences can contribute to your team, 
          have any questions, or just want to say hello, feel free to reach out. 
          You can count on hearing back from me!
        </p>
      </div>
      <div className="flex flex-row justify-center items-center gap-4 lg:px-6 mb-4">
        <a
          href="mailto:vish.pange@gmail.com"
          target="_blank"
